...
import styles from "./CadastroFuncionarios.module.scss";
...
const CadastroFuncionarios = (props) => {
  ...
  return (
    <div className={styles.principal}>
      <h1>
        Cadastro > Funcionário > <span>Novo Funcionário</span>
      </h1>
      <div className={styles.conteudo}>
        <form onSubmit={formik.handleSubmit}>
          <div className={styles.conteudoSection}>
            <Card className={styles.novoFuncionario}>
              <Card.Header as="h5" className={styles.headerNovoFuncionario}>
                Novo Funcionário
              </Card.Header>
              <Card.Body className={styles.bodyNovoFuncionario}>
        ...
        <div className={styles.conteudoAside}>
          <ButtonCustom
            title={"Funcionários"}
            icon={faUserFriends}
            desc={"LISTAGEM FUNCIONÁRIOS"}
            onClick={() => history.push("/Cadastro/ListagemFuncionarios")}
          ></ButtonCustom>
        </div>
      </div>
    </div>
